;(() => {
  ...
  var ht = typeof window < 'u' ? window : typeof globalThis < 'u' ? globalThis : global
  var Ct = class l {
    ...
    _getObserver() {
      return (
        ...
        (this._observer = new ResizeObserver((e) => {
          for (let t of e) (l.entries.set(t.target, t), this._listeners.get(t.target)?.(t))
        }))
      )
    }
  }
  ...
  function aa(l) {
    if (l.fragment !== null) {
      ...
      let e = l.dirty
      ;((l.dirty = [-1]), l.fragment && l.fragment.p(l.ctx, e), l.after_update.forEach(Ae))
    }
  }
  function wl(l) {
    let e = [],
  ...
  function _e(l, e, t) {
    ...
    ;(s && s.m(e, t),
      Ae(() => {
        ...
        ;(l.$$.on_destroy ? l.$$.on_destroy.push(...r) : H(r), (l.$$.on_mount = []))
      }),
      a.forEach(Ae))
  }
  function Qe(l, e) {
  ...
  typeof HTMLElement == 'function' &&
    (oa = class extends HTMLElement {
      ...
      $$l_u = new Map()
      constructor(l, e, t) {
        ;(super(), (this.$$ctor = l), (this.$$s = e), t && this.attachShadow({ mode: 'open' }))
      }
      addEventListener(l, e, t) {
        if (((this.$$l[l] = this.$$l[l] || []), this.$$l[l].push(e), this.$$c)) {
          let s = this.$$c.$on(l, e)
          this.$$l_u.set(e, s)
        }
      ...
      async connectedCallback() {
        if (((this.$$cn = !0), !this.$$c)) {
          ...
          for (let a of this.attributes) {
            ...
            r in this.$$d || (this.$$d[r] = Xt(r, a.value, this.$$p_d, 'toProp'))
          }
      ...
      $$g_p(l) {
        return (
          Object.keys(this.$$p_d).find(
            (e) =>
              this.$$p_d[e].attribute === l || (!this.$$p_d[e].attribute && e.toLowerCase() === l)
          ) || l
        )
      }
    })
  function Xt(l, e, t, s) {
    let a = t[l]?.type
    if (((e = a === 'Boolean' && typeof e != 'boolean' ? e != null : e), !s || !t[l])) return e
    if (s === 'toAttribute')
      switch (a) {
        case 'Object':
        case 'Array':
  ...
  var M = class {
    ...
    $set(e) {
      this.$$set && !Wl(e) && ((this.$$.skip_bound = !0), this.$$set(e), (this.$$.skip_bound = !1))
    }
  }
  ...
  function Qt(l, e = {}) {
    ...
    if (ua.call(Et, a)) {
      let n = Et[a]
      return (e.normalize === void 0 || e.normalize === null || e.normalize) && typeof n == 'string'
        ? Qt(n)
    ...
    if (r > 1 && r < 9) {
      if (((t.language = s.slice(0, r)), r < 4)) {
        ...
        for (
          ...
          ;(t.extendedLanguageSubtags.push(s.slice(r + 1, r + 4)), (r += 4), n++)
        }
      }
      for (
        a.charCodeAt(r) === 45 &&
          ...
          a.charCodeAt(r) === 45 &&
            (T(a.charCodeAt(r + 1)) && T(a.charCodeAt(r + 2)) && !T(a.charCodeAt(r + 3))
        ...
        for (; P(a.charCodeAt(g)); ) {
          if (g - n > 7) return i(g, 1, 'Too long variant, expected at most 8 characters')
          g++
        }
      ...
      for (
        ...
        let n = r + 2,
          g = 0
        for (; a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)) && P(a.charCodeAt(n + 2)); ) {
          let C = n + 1
          for (n = C + 2, g++; P(a.charCodeAt(n)); ) {
            if (n - C > 7) return i(n, 2, 'Too long extension, expected at most 8 characters')
            n++
          }
        }
        if (!g)
          return i(n, 4, 'Empty extension, extensions must have at least 2 characters of content')
        ;(t.extensions.push({
    ...
    if (
      ...
      for (; a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)); ) {
        ...
        for (n = g; P(a.charCodeAt(n)); ) {
          if (n - g > 7) return i(n, 5, 'Too long private-use area, expected at most 8 characters')
          n++
        }
    ...
    return {
      c() {
        ;(i && i.c(),
          ...
          _(s, 'class', 'pagefind-ui__result-title pagefind-ui__loading svelte-j9e30'),
          _(r, 'class', 'pagefind-ui__result-excerpt pagefind-ui__loading svelte-j9e30'),
      ...
      p(n, g) {
        n[0] ? i || ((i = ql(n)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null))
      },
      d(n) {
        ;(n && (B(e), B(t)), i && i.d(n))
      },
  ...
  function ql(l) {
    ...
    return {
      c() {
        ;((e = F('div')),
          _(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-j9e30'))
      },
      m(t, s) {
        h(t, e, s)
      },
  ...
  function $l(l) {
    ...
    return {
      c() {
        ;((e = F('div')), t && t.c(), _(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30'))
      },
      m(s, a) {
    ...
    return {
      ...
      p(a, r) {
        ;(r & 2 && !ge(e.src, (t = a[1].meta?.image)) && _(e, 'src', t),
          r & 2 && s !== (s = a[1].meta?.image_alt || a[1].meta?.title) && _(e, 'alt', s))
      },
      d(a) {
        a && B(e)
      },
  ...
  function da(l) {
    ...
    return {
      c() {
        ;((e = F('li')), a.c(), _(e, 'class', 'pagefind-ui__result svelte-j9e30'))
      },
      m(r, i) {
        ;(h(r, e, i), a.m(e, null))
      },
      p(r, [i]) {
        s === (s = t(r, i)) && a ? a.p(r, i) : (a.d(1), (a = s(r)), a && (a.c(), a.m(e, null)))
      },
      i: R,
      o: R,
      d(r) {
  ...
  function Aa(l, e, t) {
    let { show_images: s = !0 } = e,
      ...
      g = [],
      C = (c, d) => {
        if (!c || /^[a-z][a-z0-9+.-]*:/i.test(c) || /^\/\//.test(c) || c.startsWith('/')) return c
        try {
      ...
      u = async (c) => {
        ;(t(1, (n = await c.data())),
          t(1, (n = a?.(n) ?? n)),
          n.meta?.image &&
            t(1, (n = { ...n, meta: { ...n.meta, image: C(n.meta.image, n.meta.url || n.url) } })),
  ...
  var kt = class extends M {
      constructor(e) {
        ;(super(), K(this, e, Aa, da, O, { show_images: 0, process_result: 4, result: 5 }))
      }
    },
    as = kt
  function rs(l, e, t) {
    ...
    return {
      c() {
        ;(i && i.c(),
          ...
          _(s, 'class', 'pagefind-ui__result-title pagefind-ui__loading svelte-4xnkmf'),
          _(r, 'class', 'pagefind-ui__result-excerpt pagefind-ui__loading svelte-4xnkmf'),
      ...
      p(n, g) {
        n[0] ? i || ((i = ns(n)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null))
      },
      d(n) {
        ;(n && (B(e), B(t)), i && i.d(n))
      },
    ...
    return {
      ...
      p(m, f) {
        if (
          ...
          m[4] ? (c ? c.p(m, f) : ((c = cs(m)), c.c(), c.m(t, C))) : c && (c.d(1), (c = null)),
          f & 8)
        ) {
          d = V(m[3])
          let p
  ...
  function ns(l) {
    ...
    return {
      c() {
        ;((e = F('div')),
          _(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-4xnkmf'))
      },
      m(t, s) {
        h(t, e, s)
      },
  ...
  function gs(l) {
    ...
    return {
      c() {
        ;((e = F('div')), t && t.c(), _(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf'))
      },
      m(s, a) {
        ;(h(s, e, a), t && t.m(e, null))
      },
  ...
  function cs(l) {
    ...
    return {
      c() {
        ;((e = F('p')), _(e, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf'))
      },
      m(s, a) {
  ...
  function us(l) {
    ...
    return {
      ...
      m(u, A) {
        ;(h(u, e, A), b(e, t), b(t, s), b(s, r), b(e, n), b(e, g), (g.innerHTML = C))
      },
      p(u, A) {
  ...
  function ma(l) {
    ...
    return {
      c() {
        ;((e = F('li')), a.c(), _(e, 'class', 'pagefind-ui__result svelte-4xnkmf'))
      },
      m(r, i) {
        ;(h(r, e, i), a.m(e, null))
      },
  ...
  var Lt = class extends M {
      constructor(e) {
        ;(super(), K(this, e, ba, ma, O, { show_images: 0, process_result: 6, result: 7 }))
      }
    },
    As = Lt
  function _s(l, e, t) {
  ...
  function ms(l) {
    ...
    return {
      ...
      p(g, C) {
        if ((C & 112 && s !== (s = g[4]('filters_label', g[5], g[6]) + '') && W(a, s), C & 143)) {
    ...
    return {
      ...
      p(U, y) {
        ;((l = U),
          ...
          y & 3 && z(e, 'pagefind-ui__filter-value--checked', l[0][`${l[10]}:${l[14]}`]))
      },
      d(U) {
        ;(U && B(e), (m = !1), f())
      },
  ...
  function Fs(l) {
    ...
    return {
      ...
      p(d, o) {
        if (
          (o & 2 && s !== (s = d[10].replace(/^(\w)/, ps) + '') && (t.innerHTML = s),
        ...
        o & 138 && u !== (u = d[7] || d[3].map(Bs).includes(d[10].toLowerCase())) && (e.open = u)
      },
      d(d) {
        ;(d && B(e), $(c, d))
      },
    ...
    return (
      ...
      (l.$$.update = () => {
        if (l.$$.dirty & 258 && s && !u) {
          ...
          d.length === 1 && Object.entries(d[0][1])?.length <= 6 && t(7, (A = !0))
        }
      }),
      [C, s, a, r, i, n, g, A, u, c]
    )
      ...
      Ce.push(() => Ol(e, 'selected_filters', a)),
      {
        ...
        p(i, n) {
          ...
          ;(n[0] & 32 && (g.show_empty_filters = i[5]),
            ...
            !t && n[0] & 1 && ((t = !0), (g.selected_filters = i[0]), Yl(() => (t = !1))),
            e.$set(g))
        },
        i(i) {
  ...
  function Gs(l) {
    ...
    return (
      ...
      {
        c() {
          ;((e = F('div')), s.c(), _(e, 'class', 'pagefind-ui__results-area svelte-e9gkc3'))
        },
        m(g, C) {
  ...
  function Gg(l) {
    let e,
      ...
      g
    function C(I, m) {
      return I[13].results.length === 0 ? kg : I[13].results.length === 1 ? Eg : Xg
    }
    let u = C(l, [-1, -1]),
      A = u(l),
    ...
    return {
      ...
      p(I, m) {
        ;(u === (u = C(I, m)) && A ? A.p(I, m) : (A.d(1), (A = u(I)), A && (A.c(), A.m(e, null))),
          m[0] & 139292 &&
  ...
  function Xg(l) {
    let e =
        l[20]('many_results', l[19], l[7])
          ...
          .replace(
            /\[COUNT\]/,
            new Intl.NumberFormat(l[7].language || l[19].language).format(l[13].results.length)
          ) + '',
      t
    return {
      c() {
  ...
  function Eg(l) {
    let e =
        l[20]('one_result', l[19], l[7])
          .replace(/\[SEARCH_TERM\]/, l[16])
          .replace(/\[COUNT\]/, new Intl.NumberFormat(l[7].language || l[19].language).format(1)) +
        '',
      t
    return {
      c() {
          ...
          e !==
            (e =
              s[20]('one_result', s[19], s[7])
                ...
                .replace(
                  /\[COUNT\]/,
                  new Intl.NumberFormat(s[7].language || s[19].language).format(1)
                ) + '') &&
          W(t, e)
      },
      d(s) {
  ...
  function kg(l) {
    let e = l[20]('zero_results', l[19], l[7]).replace(/\[SEARCH_TERM\]/, l[16]) + '',
      t
    return {
      c() {
        t = G(e)
  ...
  function Lg(l) {
    let e, t
    return (
      (e = new as({ props: { show_images: l[2], process_result: l[4], result: l[53] } })),
      {
        c() {
          _t(e.$$.fragment)
        },
  ...
  function Xs(l) {
    ...
    return {
      ...
      p(i, n) {
        n[0] & 524416 && t !== (t = i[20]('load_more', i[19], i[7]) + '') && W(s, t)
      },
      d(i) {
        ;(i && B(e), (a = !1), r())
      },
  ...
  function Es(l) {
    ...
    return {
      c() {
        ;((e = F('p')), (s = G(t)), _(e, 'class', 'pagefind-ui__message svelte-e9gkc3'))
      },
      m(a, r) {
        ;(h(a, e, r), b(e, s))
      },
      p(a, r) {
        r[0] & 589952 &&
          t !== (t = a[20]('searching', a[19], a[7]).replace(/\[SEARCH_TERM\]/, a[16]) + '') &&
          W(s, t)
      },
      d(a) {
        a && B(e)
  ...
  function Wg(l) {
    ...
    return {
      ...
      p(U, y) {
        ;((!o || (y[0] & 524416 && a !== (a = U[20]('placeholder', U[19], U[7])))) &&
          _(s, 'placeholder', a),
          (!o || (y[0] & 524416 && r !== (r = U[20]('placeholder', U[19], U[7])))) &&
            _(s, 'title', r),
          (!o || y[0] & 256) && (s.autofocus = U[8]),
          y[0] & 512 && s.value !== U[9] && oe(s, U[9]),
          (!o || y[0] & 524416) && g !== (g = U[20]('clear_search', U[19], U[7]) + '') && W(C, g),
          ...
          (!o || (y[0] & 524416 && d !== (d = U[20]('search_label', U[19], U[7])))) &&
            _(t, 'aria-label', d),
      ...
      d(U) {
        ;(U && B(e), l[35](null), l[36](null), f && f.d(), p && p.d(), (I = !1), H(m))
      },
    }
  }
  ...
  function Vg(l, e, t) {
    ...
    for (let Q = 0; Q < a.length; Q++) s[a[Q]] = { language: a[Q], ...Us[Q].strings }
    let { base_path: r = '/pagefind/' } = e,
      ...
      kl = (Q) => {
        ...
        let X = document.activeElement,
          L = X && (X.tagName === 'INPUT' || X.tagName === 'TEXTAREA' || X.isContentEditable)
    ...
    ;(xt(() => {
      ...
      yt(() => {
        ;(E?.destroy?.(), (E = null), q && document.removeEventListener('keydown', kl))
      }))
    let Ll = async () => {
        if (!bt && (t(12, (bt = !0)), !E)) {
          let Q
...
`)
          ...
          await Q.options(X)
          for (let L of f) {
            if (!L.bundlePath) throw new Error('mergeIndex requires a bundlePath parameter')
            let Y = L.bundlePath
      ...
      Ws = async () => {
        E && ((Xl = await E.filters()), (!Ie || !Object.keys(Ie).length) && t(18, (Ie = Xl)))
      },
      Ss = (Q) => {
        let X = {}
        return (
      ...
      Ds = async (Q, X) => {
        ...
        Gl === L &&
          (ne.filters && Object.keys(ne.filters)?.length && t(18, (Ie = ne.filters)),
          t(13, (Zl = ne)),
          t(14, (ft = !1)),
          t(17, (pt = i)))
      },
      ...
      Hs = (Q) => {
        ;(Q.key === 'Escape' && (t(9, (S = '')), v.blur()), Q.key === 'Enter' && Q.preventDefault())
      }
    function Ms() {
  ...
  try {
    document?.currentScript &&
      ...
      (yl = new URL(document.currentScript.src).pathname.match(/^(.*\/)(?:pagefind-)?ui.js.*$/)[1])
  } catch {
    yl = '/pagefind/'
  }
  var mt = class {
